translations = {
    "English": {
        ...
        "error": "Error",
        "success": "Success",
        "select_folders": "Please select both input and output folders before generating the map.",
        "map_generated": "Folder map generated successfully at:",
...
- Click "Close FMG" to exit the application.
    ...
    "Italiano": {
        ...
        "error": "Errore",
        "success": "Successo",
        "select_folders": "Seleziona sia la cartella di input che quella di output prima di generare la mappa.",
        "map_generated": "Mappa della cartella generata con successo in:",
...
- Clicca il pulsante "🌞/🌙" per alternare tra modalità chiara e scura.
